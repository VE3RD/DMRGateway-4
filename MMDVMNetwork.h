...
{
public:
	CMMDVMNetwork(const std::string& rptAddress, unsigned short rptPort, const std::string& localAddress, unsigned short localPort, unsigned short smartnet, bool debug);
	~CMMDVMNetwork();
